...
import {
  AnswerlessFlag, BasicAPI, FinalUpdateFlag, Flag, FlagResponse, PostAnswer, Register, Score, UpdateFlag, User,
} from './types';
...
class Requester {
  ...
  getAllFlags = (): Promise<BasicAPI<Array<FlagResponse>>> => get(urls.flag, {});
